<%-- 
    Document   : jugadores.jsp
    Created on : 25-feb-2024, 11:41:26
    Author     : Alejandro
--%>
            ...
            <main>
                <div class="shadow">
                    ...
                    <div class="row justify-content-center pt-3 px-2">
                        <c:forEach items="${equipo.jugadorList}" var="jugador">
                                ...
                                <div class="card position-relative">
                                    ...
                                    <div class="position-absolute bottom-0 end-0"><span class="h2">${jugador.likes}</span>
                                        <a href="Controller?op=like&idjugador=${jugador.id}"> 
                                            <img src="img/thumbs.png" alt="" width="40" class="ms-2 mb-3"></a></div>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
